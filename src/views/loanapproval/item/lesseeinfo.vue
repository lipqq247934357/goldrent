    ...
    <div class="businfosss tabsinfo">
        <div class="subtabs">
            <el-tabs type="border-card">
                <el-tab-pane :key="index" :label="'承租人' + parseInt(index + 1)" v-for="(item,index) in lesseeinfolist">
                    ...
                    <div class="assetsinfo">
                        <div class="div0">
                            <ul class="infolist">
                                ...
                                <li v-if="item.custMarriage == 'divorced'">
                                    <span>是否有离婚协议</span>
                                ...
                                <li>
                                    ...
                                    <span v-for="custType in statuslist.custType"
                                          v-if="item.custType == custType.optionCode">
                                    <!-- <select class="" name="" disabled>
                                ...
                                <li>
                                    <span>教育程度</span>
                                    <!-- <span>{{item.custType}}</span>  v-if="item.custType == cation.optionCode" -->

                                    <span v-for="cation in statuslist.custducation"
                                          v-if="item.custEducation == cation.optionCode">
                                    {{cation.optionName}}
                                </span>
                        ...
                        <div class="assetsinfoul">
                            ...
                            <ul class="infolist" v-for="spouse in item.mateInfo">
                                ...
                                <li>
                                    <span>客户类别</span>
                                    <span v-for="custType in statuslist.custType"
                                          v-if="spouse.custType == custType.optionCode">
                                    {{custType.optionName}}
                                </span>
                                    <span v-if="spouse.custType == ''"></span>
                                </li>
                                <li>
                                    <span>联系电话</span>
                                    <span>
                                ...
                                <li>
                                    <span>教育程度</span>
                                    <span v-for="cation in statuslist.custducation"
                                          v-if="spouse.custEducation ==cation.optionCode">
                                    {{cation.optionName}}
                                </span>
                        ...
                        <div class="assetsinfoul" v-if="item.hasChildren == 'Y'">
                            <h3>&nbsp;&nbsp;&nbsp;子女情况</h3>
                        ...
                        <div class="div1">
                                ...
                                <ul class="infolist" v-for="assetsinfouls in item.assetsHouses">
                                    <li>
                                        ...
                                        <span v-for="housrType in statuslist.houseType"
                                              v-if="assetsinfouls.type == housrType.optionCode">
                                        <!-- <select class="" name="" disabled>
                            ...
                            <div class="assetsinfoul">
                                ...
                                <ul class="infolist" v-for="finance in item.assetsFinances">
                                    <li>
                                        <span>存款(元)</span>
                                        <span>{{finance.deposit && formatNumber(finance.deposit)}}</span>
                                    </li>
                                    <li>
                                        <span>大额存单(元)</span>
                                        <span>{{finance.bigDeposit && formatNumber(finance.bigDeposit)}}</span>
                                    </li>
                                    <li>
                                        <span>债券(元)</span>
                                        <span>{{finance.bond && formatNumber(finance.bond)}}</span>
                                    </li>
                                    <li>
                                        <span>股票(元)</span>
                                        <span>{{finance.shares && formatNumber(finance.shares)}}</span>
                                    </li>
                                    <li>
                                        <span>理财产品(元)</span>
                                        <span>{{finance.products && formatNumber(finance.products)}}</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="assetsinfoul">
                                ...
                                <ul class="infolist" v-for="car in item.assetsVehicles">
                                    ...
                                    <li>
                                        <span>当前估价（元）</span>
                                        <span>{{car.currEvaluation && formatNumber(car.currEvaluation)}}</span>
                                    </li>
                                    <li>
                                        <span>车辆牌号</span>
                                    ...
                                    <li>
                                        <span>发票金额（元）</span>
                                        <span>{{car.invoiceAmount && formatNumber(car.invoiceAmount)}}</span>
                                    </li>
                                    <li style="border-bottom: 0;">
                                        <span>是否获取发票</span>
                        ...
                        <div class="div3">
                            ...
                            <div class="assetsinfoul">
                                ...
                                <ul class="infolist" v-for="incomeFarmMachineryWork in item.incomeFarmMachineryWork">
                                    ...
                                    <li>
                                        <span>单亩成本（元）</span>
                                        <span>{{incomeFarmMachineryWork.oneCost && formatNumber(incomeFarmMachineryWork.oneCost)}}</span>
                                    </li>
                                    <li>
                                        <span>单亩收入（元）</span>
                                        <span>{{incomeFarmMachineryWork.oneIncome && formatNumber(incomeFarmMachineryWork.oneIncome)}}</span>
                                    </li>
                                    <li>
                                        <span>结余（元）</span>
                                        <span>{{incomeFarmMachineryWork.surplus && formatNumber(incomeFarmMachineryWork.surplus)}}</span>
                                    </li>
                            ...
                            <div class="assetsinfoul">
                                ...
                                <ul class="infolist" v-for="incomeOthers in item.incomeOthers">
                                    ...
                                    <li>
                                        <span>本年收入（元）</span>
                                        <span>{{incomeOthers.currYearIncome && formatNumber(incomeOthers.currYearIncome)}}</span>
                                    </li>
                                    <li>
                                        <span>本年支出（元）</span>
                                        <span>{{incomeOthers.currYearPay && formatNumber(incomeOthers.currYearPay)}}</span>
                                    </li>
                                    <li>
                                        <span>结余（元）</span>
                            ...
                            <div class="assetsinfoul">
                                ...
                                <ul class="infolist" v-for="incomeDebtRatios in item.incomeDebtRatios">
                                    <li>
                                        <span>结余合计（元）</span>
                                        <span>{{incomeDebtRatios.totalSurplus && formatNumber(incomeDebtRatios.totalSurplus)}}</span>
                                    </li>
                                    <li>
                                        <span>年租金支出（元）</span>
                                        <span>{{incomeDebtRatios.annualRentalExpense && formatNumber(incomeDebtRatios.annualRentalExpense)}}</span>

                                    </li>
                                    <li>
                                        <span>其他负债支出（元）</span>
                                        <span>{{incomeDebtRatios.otherDebtExpense && formatNumber(incomeDebtRatios.otherDebtExpense)}}</span>
                                    </li>
                                    <li>
                                        <span>年支出合计（元）</span>
                                        <span>{{incomeDebtRatios.totalAnnualExpense && formatNumber(incomeDebtRatios.totalAnnualExpense)}}</span>
                        ...
                        <div class="div3">
                            ...
                            <div class="imgbox-less" v-for="value in imgFile">
                                ...
                                <ul>
                                    <imgLine :bussNo="bussNo" :index="index" :key="val.key" :name="val"
                            ...
                            if (res.data.code == '2000000') {
                                ...
                                for (let i = 0; i < this.lesseeinfolist.length; i++) {
                                    ...
                                    this.$post('/getConstantConfig', {
                                        dictionaryCode: ['custMarriage', 'custType', 'custSex', 'custRelation', 'houseType', 'isGuarantee', 'custEducation']
                                    }).then(res => {
